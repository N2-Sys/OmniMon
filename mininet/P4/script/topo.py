...
def main():
    ...
    for n in xrange(nb_hosts):
        ...
        for i in xrange(nb_hosts):
            h.cmd("arp -s 10.0.0.%d 00:00:00:00:00:%02x" % (i+1,i+1))
            #print 'h%d' % (n + 1), "arp -s 10.0.0.%d 00:00:00:00:00:%02x" % (i+1,i+1)
